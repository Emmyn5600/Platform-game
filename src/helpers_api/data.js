export default class Element {
  ...
  export const welcomeContent = new Element().find('#welcome');
  export const gameContainer = new Element().find('#game-container');
  
  export const usernameDiv = new Element().find('#username');
  ...
  export const lbackBtn = new Element().find('#back-btn');
  
  export const playBtn = new Element().find('#play-btn');
  export const pauseBtn = new Element().find('#stop-btn');
